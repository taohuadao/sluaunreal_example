...
ULuaGameInstance::ULuaGameInstance() :state("main",this) {

}

void ULuaGameInstance::Init()
{
    state.onInitEvent.AddUObject(this, &ULuaGameInstance::LuaStateInitCallback);
    state.init();
...
void ULuaGameInstance::Shutdown()
{
    state.close();
}
...
void ULuaGameInstance::LuaStateInitCallback()
{
